...
if (message.content.startsWith("https://discord.gg/")) {
  ...
  message.author.send(` دانرا تۆش ڕیکلامەکە بکە https://discord.gg/9KexHevsXq) // لینکی سێرڤەری خۆت لیرە دابنی بە هەتا هەتای بێت
...
client.login("Nzc5MDIzNTU2NTAzNzk3Nzgx.X7agOQ.ShSBhbWJK4XtxYbROMcvFXh8tkw");//تۆکین لێرە دانێ
